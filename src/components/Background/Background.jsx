...
const Background = () => {
  return (
    <div className="background">
      <svg className="wave wave1" xmlns="http://www.w3.org/2000/svg" width="1440" height="111" viewBox="0 0 1440 111" fill="none">
      ...
      <svg className="wave wave2" xmlns="http://www.w3.org/2000/svg" width="1440" height="111" viewBox="0 0 1440 111" fill="none">
